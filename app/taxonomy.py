...
ROLE_RULES = [
    ...
    ("software_testing", ["软件测试", "系统测试", "自动化测试", "接口测试", "software test", "test development"]),
    ("hardware_testing", ["硬件测试", "芯片测试", "嵌入式测试", "电子测试", "hardware test"]),
    ("quality_management", ["质量管理", "质量体系", "供应商质量", "生产质量", "品质管理", "quality management", "supplier quality"]),
