...
- A reusable Beisen-adapter probe was attempted after the public page exposed the 2027 campus project metadata.
- The run failed at the public job-page request stage with `public_job_page_request_failed`; no concrete detail was accepted and no jobs were written or deactivated.
- Stop decision: disable this source for the fast batch and do not retry without new API evidence or a targeted adapter repair.
