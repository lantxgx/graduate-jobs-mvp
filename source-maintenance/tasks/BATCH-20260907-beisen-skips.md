...
| 中国外运 | `https://sinotrans.zhiye.com/campus` | 公开入口可访问，但短范围内无法完成岗位总量/分页核验，停止接入，不再重复请求 |
| 爱奇艺、道通科技 | `https://iqiyi.zhiye.com/campus`、`https://autel.zhiye.com/campus` | 入口可访问但单源运行未形成合格具体岗位，已暂停，不再重复请求 |
| 奕斯伟计算、上海航天、瀚博半导体、华硕、无锡村田 | 对应公开北森门户 | 岗位请求失败、详情不合格或分页核验困难，已暂停，不再重复请求 |
| 普渡机器人、龙蟠科技 | 对应公开北森门户 | 短范围内无法完成岗位总量/分页核验，已暂停，不再重复请求 |
