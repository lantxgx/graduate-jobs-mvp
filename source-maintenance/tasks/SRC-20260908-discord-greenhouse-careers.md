# SRC-20260908-discord-greenhouse-careers

- State: integrated
- Company: Discord
- Source ID: discord-greenhouse-careers
- Owner/agent: Codex
...
## Official evidence
- Official company site: https://discord.com/careers (HTTP 200 in bounded probe)
- Career entry/final URL: https://discord.com/careers
- Ownership evidence URL and visible evidence: official Discord careers page
- ATS/platform: Greenhouse
- Public list URL: https://boards-api.greenhouse.io/v1/boards/discord/jobs?content=true
...
- Source-reported total: 48 observed in bounded probe
...
- Exact next action: run the single-source worker and validate the quality gate
