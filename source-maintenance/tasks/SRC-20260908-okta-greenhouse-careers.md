# SRC-20260908-okta-greenhouse-careers

- State: blocked
- Company: Okta
- Source ID: okta-greenhouse-careers
- Owner/agent: Codex
...
## Official evidence
- Official company site: https://www.okta.com/company/careers/ (HTTP 200 in bounded probe)
- Career entry/final URL: https://www.okta.com/company/careers/
- Ownership evidence URL and visible evidence: official Okta careers page
- ATS/platform: Greenhouse
- Public list URL: https://boards-api.greenhouse.io/v1/boards/okta/jobs?content=true
...
- Source-reported total: 312 observed in bounded probe
...
- Single-source command: worker completed; 1 accepted/created
- jobs_found/created/updated: 1/1/0
- accepted/quarantined: 1/0
- `validate_source.py` result: failed minimum 3-job gate (1 active)
